...
def main():
	...
	plog=open('files/predict.log','w')
        print "plog opened"
	metriclog=open('files/metric.log','wb')
        print "metriclog opened"
	mlog=csv.writer(metriclog)
	scalelog=open('files/scale.log','w')
        print "scalelog opend"
	accesslog=open('/var/log/apache2/access.log','r')
        print "access log opened"
